...
var I18n = {
  ...
  base: {
    ...
    'rail.live': 'Live TV', 'rail.movies': 'Movies', 'rail.series': 'Series',
    ...
    'tmdb.public': 'Public edition', 'tmdb.publicInfo': 'Enter your own free TMDb key. Playback continues to work without it.',
    ...
    'tmdb.familyActive': 'Family key active',
  ...
  dictionaries: {
    tr: {
      ...
      'rail.live': 'Canlı TV', 'rail.movies': 'Filmler', 'rail.series': 'Diziler',
      ...
      'tmdb.public': 'Public sürümü', 'tmdb.publicInfo': 'Kendi ücretsiz TMDb anahtarınızı girin. Anahtar olmadan da oynatma çalışmaya devam eder.',
      ...
      'tmdb.familyActive': 'Family anahtarı etkin',
      ...
      'tmdb.availableIn': '{region} bölgesinde izlenebilir', 'tmdb.none': 'Bu bölgede platform gösterimi bulunamadı.',
      'tmdb.unknown': 'Bu bölge için platform bilgisi sağlanmamış.',
